...
SafeSpot.Transparency = .75
                ...
                local Window = OrionLib:MakeWindow({Name = "Ability Wars | Frog Hub", HidePremium = true, IntroEnabled = false, SaveConfig = true, ConfigFolder = "OrionTest"})
...
game:GetService("ReplicatedStorage"):FindFirstChild("Remote Events").Punch:FireServer(workspace:WaitForChild(Boss),Vector3.new,0,Boss:FindFirstChild("Right Leg"))
wait(.1)
end
end
end
...
AntiVoid.Material = Enum.Material.Neon
                ...
                local Window = OrionLib:MakeWindow({Name = "Team Battles | Frog Hub", HidePremium = true, IntroEnabled = false, SaveConfig = true, ConfigFolder = "OrionTest"})
